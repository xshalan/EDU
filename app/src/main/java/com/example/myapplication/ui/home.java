...
public class home extends AppCompatActivity
    ...
    private LessonsDatabase database;
    private SharedPreferences sharedPreferences;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_home);
        database = LessonsDatabase.getInstance(this);
    ...
    protected void onStart() {
        super.onStart();
        progressBar.setProgress(sharedPreferences.getInt(DatabaseInit.OVERALL_PROGRESS_KEY,1));
        Log.d("HomeActivity","overall progress->  " + DatabaseInit.overAllProgress);
    }
